...
- Meantime, even if we measure people without error, cross cultural studies might select on people with different incomes, leading to bias in the absence of measurement error (and even if we do not control for income!)
...
- To Consider Measurment Validity within classical framework of External and Internal Validity
...
- In doing so, much of what confused in in psychology will be clear. 
...
2.  Validity = Obtaining Valid Scientific Inference.
3.  Confounder = Association in Data is Spurious
