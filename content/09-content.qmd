...
- And download the relevant libraries.
...
$$ g_1 = \text{Intervention 1 - Intervention 2} = E[Y(\mathbf{d}^\lambda) - Y(\mathbf{d}^\phi)] $$

$$ g_2 = \text{Intervention 1 - Intervention 2} = E[Y(\mathbf{d}^\lambda) - Y(\mathbf{d}^\phi)] $$
...
### Machine Learning -- example (from https://osf.io/cnphs )

The following is example text you might tweak for you Method section
...
the pre-stated protocols in Bulbulia [@bulbulia2024PRACTICA]. The integration of TMLE
