...
### Comparing Heterogenity in Groups. 
...
@fig-dag-effect-modification consider whether effect-modification of $A$ on $Y$ across levels of $G$. Because we are not interested in the causal effect of $G$ as such, but rather, how the effect of $A$ varies across $G$, we would *not* adjust by $Q$.  

Consider, if we were to include either $Q$ or $Z$ in the model, we would attenuate the effect modification of $A$ by $G$.  Can you tell why? 
