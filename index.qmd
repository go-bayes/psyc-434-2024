...
**You can access the course lectures by navigating to the "Content" section and selecting the appropriate tab**

## Class times and locations

**Lectures** Day/Time: Mondays, 11:00-12:50pm
...
**Lecturers** Dr.Torven Schalk [torven.schalk\@vuw.ac.nz](mailto:torven.schalk@vuw.ac.nz){.email}
...
1.  **Programming in R** students will learn the basics of programming in the statistical language R, gaining essential computational tools for psychological research. This will lay the foundation for applying data analysis techniques in a causal inference framework, and beyond.

2.  **Understanding Causal Inference.** students will develop a robust understanding of causal inference concepts and approaches, with particular emphasis on how they mitigate common pitfalls in cross-cultural research. We will focus on how to design studies, analyze data, and draw strong conclusions about cause-and-effect relationships across cultures.

5.  **Understanding Measurement in Comparative Settings.** students will learn techniques for constructing and validating psychometrically sound measures across diverse cultures. We will examine how to ensure measurements are reliable, cross-culturally valid, and aligned with theoretical constructs, while keeping a strong focus on causal reasoning. 
...
- **Second Test (50 minutes, total time allowed: 1 hour 50 minutes)**:
    - Builds upon the first test's concepts, emphasizing the application of basic conceptual, statistical, and theoretical knowledge.

### Assessment 3: Research Report

- **Title**: "Causal Inference in Cultural Psychology: Examining the Effect of Exposure on Dimensions of Well-being Modified by Cultural or Sociodemographic Categories".
...
- **Instructions**:
  ...
  2. **Directed Acyclic Graph (DAG)**:
        - Construct a DAG illustrating the relationships between exposure, outcomes, sociodemographic category, and potential bias sources. Ensure clarity in labeling.
  ...
  4. **Measurement Biases**:
        - Address and analyze measurement biases as relevant.
...
- **Requirements**:
    ...
    - Utilize any useful sources, citing appropriately to avoid academic misconduct.
